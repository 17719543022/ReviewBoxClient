...
#include "../ReviewBoxClient/listener.h"
...
QT_MOC_LITERAL(4, 35, 18), // "stateNetworkChange"
QT_MOC_LITERAL(5, 54, 5), // "state"
QT_MOC_LITERAL(6, 60, 15) // "stateBeltChange"

    },
    "Listener\0newSerialData\0\0strRequest\0"
    "stateNetworkChange\0state\0stateBeltChange"
};
...
void Listener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->stateNetworkChange((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->stateBeltChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Listener::newSerialData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Listener::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Listener::stateNetworkChange)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Listener::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Listener::stateBeltChange)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Listener::newSerialData(QString _t1)
{
...
// SIGNAL 1
void Listener::stateNetworkChange(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void Listener::stateBeltChange(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
